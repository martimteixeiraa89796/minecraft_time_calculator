...
minecraft_day_duration = ((minecraft_sunset_tick - minecraft_sunrise_tick) + minecraft_day_total_ticks) % minecraft_day_total_ticks
...
if sunrise <= time_to_calculate < sunset:
    ...
    night_duration = (day_total_seconds - sunset) + sunrise
    elapsed_time = (time_to_calculate - sunset + day_total_seconds) % day_total_seconds
